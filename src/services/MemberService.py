...
class MemberService:
    ...
    def addMember(self, first_name, last_name, phone, email):
        return DatabaseService.add_member(
            self.database, first_name, last_name, phone, email
        )
    ...
    def updateMember(self, member_id, first_name, last_name, phone, email):
        return DatabaseService.update_member(
            self.database, member_id, first_name, last_name, phone, email
        )
